// Background service worker for Loop Practice for YouTube Extension
...
chrome.runtime.onInstalled.addListener((details) => {
  if (details.reason === 'install') {
    console.log('Loop Practice for YouTube 확장프로그램이 설치되었습니다');
  } else if (details.reason === 'update') {
    console.log('Loop Practice for YouTube 확장프로그램이 업데이트되었습니다');
  }
}); 